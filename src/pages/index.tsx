  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management Application: Transforming the way you manage human resources, providing innovative solutions for seamless HR operations."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management Application: Transforming the way you manage human resources, providing innovative solutions for seamless HR operations.`}
            </Text>
            <Box
